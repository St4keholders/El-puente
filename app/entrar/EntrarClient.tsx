    ...
    <div className="flex min-h-[85vh] items-center justify-center px-4 py-24">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-bold text-[var(--ink)] tracking-tight">Bienvenido de nuevo</h1>
          <p className="mt-1.5 text-xs text-[var(--ink-2)]">
            Inicia sesión o regístrate con tu cuenta para continuar
          </p>
        </div>

        {errorMsg && (
          <div className="mb-6 flex items-start gap-2.5 rounded-2xl bg-red-500/10 p-3.5 text-xs text-red-500 border border-red-500/20">
        ...
        <div className="space-y-4">
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 rounded-2xl border border-[var(--line)] bg-[var(--surface-solid)] py-3 px-4 text-sm font-semibold text-[var(--ink)] hover:bg-[var(--hover)] hover:border-[var(--glass-edge)] active:scale-[0.99] disabled:opacity-50 transition-all cursor-pointer shadow-sm"
          >
            {loading ? (
          ...
          <div className="pt-4 border-t border-[var(--line)] text-center">
            <p className="text-xs text-[var(--ink-3)] leading-relaxed">
              ...
              <Link href="/terminos" className="text-[var(--accent-ink)] hover:underline">
                Términos de Servicio
              </Link>{" "}
              y la{" "}
              <Link href="/privacidad" className="text-[var(--accent-ink)] hover:underline">
            ...
            <div className="mt-4">
              <Link
                href="/"
                className="text-xs font-semibold text-[var(--ink-2)] hover:text-[var(--ink)] transition-colors"
              >
                ← Volver al inicio
              </Link>
            </div>
